...
def get_unet():
    ...
    #pool1 = BatchNormalization()(pool1, training=False)
    ...
    #pool2 = BatchNormalization()(pool2, training=False)
    ...
    #pool3 = BatchNormalization()(pool3, training=False)
    ...
    #pool4 = BatchNormalization()(pool4, training=False)
